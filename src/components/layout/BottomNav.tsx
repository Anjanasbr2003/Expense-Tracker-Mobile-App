      ...
      >
        ...
        <div className="relative z-30 flex items-center justify-center mx-2.5 shrink-0">
          ...
          <button
            ...
            className="w-12 h-12 rounded-2xl glass-button-primary text-black font-black flex items-center justify-center relative z-10 active:scale-90 active:ring-4 active:ring-lime-400/40 transition-all duration-150 cursor-pointer shadow-lg shadow-emerald-950/40 hover:shadow-lime-400/30"
